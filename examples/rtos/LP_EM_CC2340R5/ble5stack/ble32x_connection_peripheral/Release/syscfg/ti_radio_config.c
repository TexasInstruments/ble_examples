...
static const uint32_t LRF_subPhy1Mbps2MbpsRegConfig[] =
{
    ...
    0x202601AE,                     //     PBE_BLE5_RAM.PRERXIFS
...
static const uint32_t LRF_subPhy1MbpsRegConfig[] =
{
    ...
    0x00007002,                     //   RAM sparse region (address/value pairs, count = 3)
    0x20200000,                     //     PBE_BLE5_RAM.PHY
    0x2024018E,                     //     PBE_BLE5_RAM.PRETXIFS
    0x20280226,                     //     PBE_BLE5_RAM.RXTIMEOUT
...
static const uint32_t LRF_subPhy2MbpsRegConfig[] =
{
    ...
    0x00007003,                     //   RAM sparse region (address/value pairs, count = 4)
    0x20200001,                     //     PBE_BLE5_RAM.PHY
    0x202401B2,                     //     PBE_BLE5_RAM.PRETXIFS
    0x202801C2,                     //     PBE_BLE5_RAM.RXTIMEOUT
